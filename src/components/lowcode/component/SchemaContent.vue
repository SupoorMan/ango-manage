  ...
  <div class="canvas">
    ...
    <div class="canvas-center">
      <div class="canvas-center-drag">
        <schema-content-item :componentList.sync="model.componentList"></schema-content-item>

        <el-tooltip effect="light" content="组件设置" placement="bottom">
          <div class="canvas-center-drag-set flex-center" @click="content.curComponent = null">
            <i class="iconfont icon-baomihua-01"></i>
          </div>
        </el-tooltip>
      </div>
    </div>
    ...
    <div class="canvas-right">
      <!-- <component v-if="content.curComponent" :is="curComponentConfig" v-bind="content.curComponent"></component> -->
...
// import SchemaContentShape from "@/components/lowcode/component/SchemaContentShape.vue";
// import SchemaContentItem from "@/components/lowcode/component/SchemaContentItem";
