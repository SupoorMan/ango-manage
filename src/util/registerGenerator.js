...
// 注册所有schema配置组件
register(require.context('@/components/lowcode/config-template', true, /.vue/))
...
function registerSchemaInitializing() {
    const files = require.context("@/components/lowcode/custom-schema-template", true, /initializing.js$/);
    const list = [];
